...
module ODBA
  ...
  class TestStub < Test::Unit::TestCase
    ...
    def test_array_methods
      ...
      @cache.should_receive(:next_id).with(FlexMock.any, FlexMock.any).and_return(ODBA.cache.next_id)
      assert_equal([], stub)
      stub = Stub.new(9, [], [])
      assert(stub == [])
      [
    ...
    def test_to_yaml
      ...
      assert(loaded.is_a?(Stub), "loading from yaml should return a Stub and not #{loaded.class}")
